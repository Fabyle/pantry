...
public class CalendarServiceSemaine4 extends TestCase {
	...
	public void testAjouterTestMonteeEnCharge() {
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - documents", "Documentation montée en charge - Spécification et conception",
				"2013-01-31", 2, 60);
		
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - 1", "Planning des tirs de montée en charge. Tir 1",
				"2013-02-21", 1, 100);
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - 2", "Planning des tirs de montée en charge. Tir 2",
				"2013-02-25", 1, 100);
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - 3", "Planning des tirs de montée en charge. Tir 3",
				"2013-02-21", 1, 100);
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - 4", "Planning des tirs de montée en charge. Tir 4",
				"2013-02-28", 1, 100);
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - 5", "Planning des tirs de montée en charge. Tir 5",
				"2013-03-04", 1, 100);
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - 6", "Planning des tirs de montée en charge. Tir 6",
				"2013-03-07", 1, 100);
		ajouteJoursDeTravail("Nicolas", CLIENT_REUNICA + " - "
				+ CONTRIBUTION_PALIER2 + " - " + TYPE_VALIDATION + " - "
				+ P_VALID_EXPLOIT_P2+" - 7", "Planning des tirs de montée en charge. Tir 7",
				"2013-03-11", 1, 100);
	}
